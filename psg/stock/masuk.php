                                ...
                                <div class="market-status-table mt-4">
                                    ...
                                    <div class="modal fade" id="edit<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <select id="keterangan" name="keterangan" class="form-control" value="<?php echo $b['keterangan'] ?>">
                                                            <?php
						...
						<div class="modal-body">
							<form action="barang_masuk_aksi.php" method="post">
								...
								<div class="form-group">
									...
									<select name="ket" type="text" class="form-control" placeholder="Keterangan">
