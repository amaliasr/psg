...
$tanggal =date("Y-m-d");
  ...
  $query2 = mysqli_query($conn,"insert into barang_masuk (idx,tgl,npo,jumlah,keterangan,supplier,pic) values('$barang','$tanggal','$npo','$qty','$ket','$supplier','$pic')");
