                                                        ...
                                                        <div class="modal-content">
                                                            <form method="post">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <input type="text" id="password" name="password" class="form-control" value="<?php echo $p['password'] ?>" minlength="8">
                ...
                <div class="modal-body">
                    <form action="admin_aksi.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="password" type="text" class="form-control" placeholder="password" minlength="8" required>
                        </div>
                        <div class="form-group">
                            <label>Nama</label>
