...
if (isset($_POST['update'])) {
    ...
    $updatedata = mysqli_query($conn, "UPDATE customer set nama='$nama', nohp='$nohp', alamat='$alamat' where id='$id'");
...
<head>
    ...
    <title>Master Customer - Purata Samasta Gemilang</title>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="customer.php"><span><b>Master Customer</b></span></a>
                            </li>
                            <li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="datatable-dark table-responsive">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $brgs = mysqli_query($conn, "SELECT * from customer");
                                            $no = 1;
                                                        ...
                                                        <div class="modal-content">
                                                            <form method="post">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <input type="text" id="nohp" name="nohp" class="form-control" value="<?php echo $p['nohp'] ?>" minlength="8" onkeypress="return event.charCode >= 48 && event.charCode <=57">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form method="post">
                                                                <!-- Modal Header -->
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Hapus Data Admin <?php echo $p['nama'] ?></h4>
                                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                </div>
                                ...
                                <a href="laporancustomer.php" target="_blank" class="btn btn-secondary">Export Data</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="customer_aksi.php" method="post">
                        ...
                        <div class="form-group">
                            <label>No. HP</label>
                            <input name="nohp" type="text" class="form-control" placeholder="No. HP" minlength="8" onkeypress="return event.charCode >= 48 && event.charCode <=57" required>
                        </div>
                        <div class="form-group">
                            <label>Alamat</label>
                            <input name="alamat" type="alamat" class="form-control" placeholder="Alamat" required>
                        </div>
                </div>
                <div class="modal-footer">
