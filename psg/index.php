...
if(isset($_POST['btn-login'])){
	...
	$login = mysqli_query($conn,"select * from admin where username='$uname' and password='$upass';");
	// menghitung jumlah data yang ditemukan
	$session = mysqli_num_rows($login);
...
<html lang="en">
  ...
  <link href="icons.png" rel="apple-touch-icon">

	<head>
		<meta charset="utf-8">
    	<meta http-equiv="X-UA-Compatible" content="IE=edge">
    	<meta name="viewport" content="width=device-width, initial-scale=1">
    	<title>Purata Samasta Gemilang</title>
  	...
  	<body>
  		<div align="center">
  			<img src="psg.jpg" width="25%" style="margin-top:5%" \>
			<br \><br \>
			<div class="container">
				<!-- Form Input Data -->
            	<form method="post">
                	...
                	<button type="submit" class="btn btn-secondary" name="btn-login">LOGIN</button>
            	</form>
				<br \>
        	</div>
		</div>     
