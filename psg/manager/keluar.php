                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $b['nsj'] ?><?php echo $b['id'] ?></td>
                                                        ...
                                                        <td>
                                                            <a type="button" class="btn btn-success" href="setuju_keluar.php?id=<?php echo $b['id']; ?> " class="edit"> Setuju </a>
                                                        </td>
                                                            ...
                                                            <div class="modal-content">
                                                                <form method="post">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <select name="penerima" class="custom-select form-control">
                                                                            <option selected><?php echo $b['penerima'] ?></option>
                                                                            <?php
                                                                            $det = mysqli_query($conn, "select * from customer order by nama ASC") or die(mysqli_error());
